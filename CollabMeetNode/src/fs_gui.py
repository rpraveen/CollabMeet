...
class FsUIParticipant:
    ...
    def make_widget(self):
        ...
        self.builder.add_from_file(builderprefix + "user-frame.glade")
...
class FsMainUI:
    ...
    def __init__(self, gladefile, wname, mode, ip, port):
        self.mode = mode
        ...
        self.builder = gtk.Builder()
        self.builder.add_from_file(gladefile)#builderprefix + "main-window.glade")
#        self.builder.connect_signals(self)
#        self.builder.connect_signals(dic)
        self.mainwindow = self.builder.get_object(wname)#"main_window")
...
class FsUIStartup:
    ...
    def __init__(self, gladefile, wname, mode, ip, port, camera):
		if mode == 's':
			mode = SERVER
		elif mode == 'c':
			mode = CLIENT
